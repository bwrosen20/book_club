...
pablo= User.new(name:"Pablo",password:"password",password_confirmation:"password",current_vote:Book.find_by(title:"11-22-63").id,book_for_vote:Book.find_by(title:"A Game of Thrones").id,bio:"I'm a ballplayer and I'm good at what I do",favorite_book:"Moneyball")
ron = User.new(name:"Ron",password:"password",password_confirmation:"password",current_vote:Book.find_by(title:"The Great Gatsby").id,book_for_vote:Book.find_by(title:"11-22-63").id,bio:"I'm slowly working on taking down the government from the inside", favorite_book:"The Old Man and the Sea")
stephen = User.new(name:"Stephen",password:"password",password_confirmation:"password",current_vote:0,book_for_vote:Book.find_by(title:"The Great Gatsby").id,bio:"I think I know a little more about books than these guys", favorite_book:"Carrie")
